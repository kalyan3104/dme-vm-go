...
var kalyan3104ReservedTestPrefix = []byte("RESERVED")
...
func TestNewStorageContext(t *testing.T) {
	...
	storageContext, err := NewStorageContext(host, mockBlockchain, kalyan3104ReservedTestPrefix)
	require.Nil(t, err)
...
func TestStorageContext_SetAddress(t *testing.T) {
	...
	storageContext, _ := NewStorageContext(host, bcHook, kalyan3104ReservedTestPrefix)
...
func TestStorageContext_GetStorageUpdates(t *testing.T) {
	...
	storageContext, _ := NewStorageContext(host, mockBlockchainHook, kalyan3104ReservedTestPrefix)
...
func TestStorageContext_SetStorage(t *testing.T) {
	...
	storageStatus, err = storageContext.SetStorage(key, value)
	require.Equal(t, arwen.ErrStoreKalyan3104ReservedKey, err)
